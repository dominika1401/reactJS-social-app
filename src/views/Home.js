...
const Home = (props) => {
    ...
    return (
        <div className="home">
            ...
            {props.user && <FollowRecomendations user={props.user} getLatesPosts={getLatesPosts} post={posts} />}
            <div className="postList">
                {posts.map((post) => {
                    return <Post post={post} key={post.id} user={props.user} setPosts={setPosts} getLatesPosts={getLatesPosts} />;
                })}
