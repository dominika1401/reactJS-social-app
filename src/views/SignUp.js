    ...
    const validate = () => {
        ...
        if (formData.username.trim().length < 4) {
            ...
            setErrors((prevErrors) => {
                return {
                    ...prevErrors,
                    username: "Username should't have empty characters",
                }
            });
        } else {
        ...
        if (formData.password.trim().length < 6) {
            ...
            setErrors((prevErrors) => {
                return {
                    ...prevErrors,
                    password: "Password should have at least 6 charakters",
                };
            });
            ...
            setErrors((prevErrors) => {
                return {
                    ...prevErrors,
                    password: "Password should't have empty charakters",
                };
            });
    ...
    return (
        <div className="signUp">
            ...
            <form onSubmit={handleSubmit}>
                ...
                {signUpDone && <div><Link to='/login' className='btn'>Go to login</Link> </div>}
            </form>
        </div>
    )
}
